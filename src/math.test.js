...
test("Prime Number Sum from 2 to 6 is 10", () => {
    expect(Util.sumPrime(6)).toEqual(10);
});

test("Prime Number Sum from 2 to 8 is 17", () => {
    expect(Util.sumPrime(8)).toBe(17);
});

test("Multiple de 3 = Fizz | Multiple de 5 = Buzz | Multiple de 3 et 5 = FizzBuzz", () => {
    let mon_test = [1, 2, "Fizz", 4, "Buzz", "Fizz", 7, 8, "Fizz", "Buzz", 11, "Fizz", 13, 14, "FizzBuzz"];
    expect(Util.fizzBuzz(15)).toEqual(mon_test);
